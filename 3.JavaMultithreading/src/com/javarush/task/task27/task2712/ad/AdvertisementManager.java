 ...
 */
public class AdvertisementManager { //объект менеджера
    private final AdvertisementStorage storage = AdvertisementStorage.getInstance();
    private int timeSeconds;
    List<Advertisement> storageList;
    ...
    public static final Comparator<Advertisement> COMPARE = new Comparator<Advertisement>() {
        @Override
    ...
    public static final Comparator<Advertisement> COMPARE2 = new Comparator<Advertisement>() {
        @Override
        public int compare(Advertisement o2, Advertisement o1) {
            if (o1.getAmountPerOneDisplaying() - o2.getAmountPerOneDisplaying() == 0) {
                return (int)(o1.getInitialAmount()/o1.getDuration() - o2.getInitialAmount()/o2.getDuration());
            }
            else {
                return (int)(o1.getAmountPerOneDisplaying() - o2.getAmountPerOneDisplaying());
            }
